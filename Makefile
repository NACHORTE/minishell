...
#    Updated: 2023/10/07 13:04:14 by orudek           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
CC := gcc
STANDARD_FLAGS := -fsanitize=address -Wall -Wextra -Werror
RM := rm -f

SRC_DIR := src
INCLUDE_DIR := include /Users/$(USER)/.brew/opt/readline/include
OBJ_DIR := obj

LIBFT_DIR := libft
LIBFT_NAME := libft.a

LIB_L := -L/Users/$(USER)/.brew/opt/readline/lib
LIB := readline
...
INCLUDE_PATH := $(addprefix -I,$(INCLUDE_DIR)) -I$(LIBFT_DIR)/include

all: $(NAME)

$(NAME): $(OBJ) $(LIBFT_DIR)/$(LIBFT_NAME)
	$(CC) $(STANDARD_FLAGS)  $(INCLUDE_PATH) $(OBJ) $(LIBFT_DIR)/$(LIBFT_NAME) $(LIB_FLAG) $(LIB_L)  -o $@
